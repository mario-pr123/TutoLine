...
<script src="{{asset('js/tarea.js')}}"></script>
    ...
    <div class="mb-3">
        ...
        <input id="estado_objetivo" name="estado_objetivo" type="text" class="form-control" textindex="3" required>
    </div>
    <div class="mb-3">
        ...
        <select class="form-control" aria-label="Default select example" id="tutor_id_tutor" name="tutor_id_tutor" onchange="selectTutor({{count($tutors)}})">
            ...
            <option value="{{ $element->id_tutor }}">{{ $element->nombre_tutor }}</option>
            @endforeach
        </select>
    </div>
    <div class="mb-3">
