...
@section('content')
    <form action="/tutors" method="POST">
        ...
        <div class="mb-3">
            ...
            <input id="fecha_nacimiento_tutor" name="fecha_nacimiento_tutor" type="datetime-local" class="form-control" textindex="3" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input id="telefono_tutor" name="telefono_tutor" type="number"  class="form-control" textindex="4" required>
        </div>
        <div class="mb-3">
