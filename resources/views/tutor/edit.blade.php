...
@section('content')
    <form action="/tutors/{{$tutor->id_tutor}}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input id="fecha_nacimiento_tutor" name="fecha_nacimiento_tutor" type="datetime-local" class="form-control"  value="{{$tutor->fecha_nacimiento_tutor}}" textindex="3" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input id="telefono_tutor" name="telefono_tutor" type="number" maxlength="2" class="form-control"  value="{{$tutor->telefono_tutor}}" textindex="4">
        </div>
        <div class="mb-3">
