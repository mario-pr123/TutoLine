...
<div>
  ...
  <br> 
  <button type="submit" class="btn btn-primary" tabindex="4">Ver Alumnos</button>
</div>
</form>
...
<table class="table table-dark table-striper mt-4">
  ...
  @foreach($combo as $alumno)
    <tr>
      ...
      <td>{{$alumno->porcentaje==100?'Excelencia Academica':$alumno->porcentaje>90?'Sobresaliente'
      :$alumno->porcentaje>70?'Promedio':'Bajo del Promedio'}}</td> 
    </tr>
    @endforeach
    @endif
  </tbody>
